export async function up(client) {
  await client`DROP TABLE IF EXISTS beacon_issuance`;
  await client`DROP TABLE IF EXISTS eth_in_validators`;
  await client`DROP TABLE IF EXISTS beacon_states CASCADE`;
}
